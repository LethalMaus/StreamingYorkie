...
class NoInternetDialog : BaseDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBinding!!.dialogTitle.text = getString(R.string.error_no_internet_title)
        viewBinding!!.dialogDescription.text = getString(R.string.error_no_internet_description)
